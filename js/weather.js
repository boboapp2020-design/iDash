...
(function () {
  ...
  function aiSystem() {
    ...
    var base = [
      ...
      'กติกา: 1) ใช้เฉพาะตัวเลขใน facts ห้ามเดา 2) ตอบไทย กระชับ อ่านเข้าใจง่าย — ห้ามพิมพ์ชื่อ key ใน facts (เช่น soil_texture:, soil_om_pct:, fert_plant_npk) ออกมาในคำตอบ ให้เขียนเป็นประโยคปกติ 3) เรื่องปุ๋ยให้ระบุทั้งอ้อยปลูกและอ้อยตอ (N-P-K กก./ไร่) พร้อมจังหวะใส่ตามฝน 3 วันข้างหน้า (ฝนหนักให้เลื่อนหลังฝนซา ดินทราย/OM ต่ำแบ่งใส่หลายครั้ง) 4) นอกเรื่องอ้อย/อากาศ ให้ปฏิเสธ'
    ];
    return base.join('\n');
  }
